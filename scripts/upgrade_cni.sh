...
mkdir -p "${ANSIBLE_DIR}/packages/scripts/sriovMGR" || die 26 "mkdir sriovMGR failed!"
cp -r scripts/sriovMGR/* "${ANSIBLE_DIR}/packages/scripts/sriovMGR/" || die 27 "update sriovMGR failed!"
